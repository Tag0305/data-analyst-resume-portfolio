...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-between overflow-x-clip bg-[#030604] text-[#F4FFF7]">
      {/* Background Radial Glow & Thin Data Lines */}
      ...
      <FadeIn delay={0} y={-20}>
        <nav className="w-full flex flex-wrap items-center justify-between px-6 md:px-10 pt-6 md:pt-8 text-[#F4FFF7] font-medium uppercase tracking-wider text-xs sm:text-sm md:text-base lg:text-lg gap-4 z-40 relative">
          ...
          <div className="hidden md:flex items-center gap-6 text-[#A9B8AE]">
        ...
        <FadeIn delay={0.6} y={30}>
          <Magnet padding={150} strength={3}>
            <img
              ...
              className="w-full h-auto max-h-[66vh] object-contain drop-shadow-[0_15px_35px_rgba(34,197,94,0.25)] pointer-events-auto"
            />
          </Magnet>
        </FadeIn>
      </div>
      ...
      <div className="w-full flex flex-col md:flex-row items-start md:items-end justify-between px-6 md:px-10 pb-7 sm:pb-8 md:pb-10 relative z-30 gap-6">
        <FadeIn delay={0.35} y={20} className="max-w-md space-y-2">
          ...
          <p className="text-[#A9B8AE] font-light uppercase tracking-wide leading-snug text-xs sm:text-sm md:text-base">
